...
## Fase 1 — {label, e.g. "Fundação"} (Wave 1)
- [ ] **mt-XXX-001** — {título}
  - **Categoria:** backend · **Estimativa:** 3h · **Prioridade:** Alta
  - **Descrição:** ...
  - **Input:** ...
  - **Output:** ...
  - **Critérios de aceite:**
    - [ ] ...
  - **Dependências:** upstream: — · downstream: mt-XXX-002
  - **Arquivos de referência:** `path/to/file.cs`, `path/to/other.md`
  - **Contexto de execução:**
    - Estratégico: ...
    - Técnico: ...
    - Validação: `comando ou teste` → resultado esperado
