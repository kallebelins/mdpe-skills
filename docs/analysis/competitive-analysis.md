...
| A3 | **P0** | **Auto-sizing**: substituir "20-30 features" e "15-25 microtasks" por faixas derivadas do escopo (P/M/G/Complexo), **com válvula de segurança** que exige o artefato formal quando a listagem inline passa do limite. | TLC 5.1 | **8.1 / 8.2** | `docs/analysis/field-obligation-audit.md`; `skills/mdpe-backlog-discovery/SKILL.md`; `skills/mdpe-transformation/SKILL.md` |
